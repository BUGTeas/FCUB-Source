...
title @s subtitle {"translate": "fcub.check_java.rp_request_120.subtitle", "fallback": "§e可在游玩指南/群文件中找到"}
title @s title {"translate": "fcub.check_java.rp_request_120.title","fallback": "§c请添加最新版专用资源包"}