...
execute if score #system tick_operation matches 1 run title @s title {"translate": "fcub.resCheck.v2.1.0.java.title", "color": "green", "with": [{"text": "感谢你对罪如歌的支持","color": "gold"},{"translate": "fcub.resUpdate.java.title", "color": "aqua", "with": ["v2.1.0", {"translate": "fcub.joinError.bedrock.title", "color": "red", "with": [{"translate": "fcub.langRequest.java.title", "fallback": "请添加最新版专用资源包", "color": "red"}], "fallback": "%s"}], "fallback": "%2$s"}], "fallback": "%2$s"}

execute if score #system tick_operation matches 2 run title @s title {"translate": "fcub.resCheck.v2.1.0.java.title", "color": "green", "with": [{"text": "祝您金箱子把把出红","color": "gold"},{"translate": "fcub.resUpdate.java.title", "color": "aqua", "with": ["v2.1.0", {"translate": "fcub.joinError.bedrock.title", "color": "red", "with": [{"translate": "fcub.langRequest.java.title", "fallback": "请添加最新版专用资源包", "color": "red"}], "fallback": "%s"}], "fallback": "%2$s"}], "fallback": "%2$s"}

execute if score #system tick_operation matches 3 run title @s title {"translate": "fcub.resCheck.v2.1.0.java.title", "color": "green", "with": [{"text": "欢迎回归","color": "gold"},{"translate": "fcub.resUpdate.java.title", "color": "aqua", "with": ["v2.1.0", {"translate": "fcub.joinError.bedrock.title", "color": "red", "with": [{"translate": "fcub.langRequest.java.title", "fallback": "请添加最新版专用资源包", "color": "red"}], "fallback": "%s"}], "fallback": "%2$s"}], "fallback": "%2$s"}