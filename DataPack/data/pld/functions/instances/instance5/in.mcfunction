...
execute unless score #system final_battle_stage matches 6 if score #system instance5_intick matches 186 run tellraw @a [{"text":"§a如果不出意外的话, 在本轮圣山之战后, 盘古大陆的故事将会被再度揭晓。"}]
